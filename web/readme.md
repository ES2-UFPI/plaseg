...
Uma plataforma completa para automatizar o processo de gerar projetos municipais de segurança pública.
...
4. [Arquitetura Base](#arquitetura-base)
5. [Aspectos Técnicos](#aspectos-técnicos)
6. [Features Básicas](#features-básicas)
